...
import { useGetCategoryQuery, useRemoveCategoryMutation } from '../../../services/category';
import LoadingPage from '../../../components/common/LoadingPage';
import { Link } from 'react-router-dom';

const CategoryManager = () => {
    const {data: NewCate, isLoading } = useGetCategoryQuery();
    const CateNew = NewCate?.category
